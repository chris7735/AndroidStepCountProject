...
public final class Bridge extends Application {
    ...
    static final String RESTART_DATE = "restartDate";

    static final String IS_STOP_COUNTS = "isStopCounts";
    ...
    public static String StopStepCounts(int addSeconds){
        Calendar calendar = Calendar.getInstance(); // gets a calendar using the default time zone and locale.
        calendar.add(Calendar.SECOND, addSeconds);
        Date restartDate = calendar.getTime();

        Log.i("PEDOMETER", "StopStepCounts-> received seconds: " + addSeconds);
        Log.i("PEDOMETER", "StopStepCounts-> CurrentDate: " + Calendar.getInstance().getTime().toString());
        Log.i("PEDOMETER", "StopStepCounts-> RestartDate: " + restartDate.toString());

        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(appContext);
        SharedPreferences.Editor editor = sharedPreferences.edit();

        editor.putString(RESTART_DATE, restartDate.toString());
        editor.putBoolean(IS_STOP_COUNTS, true);
